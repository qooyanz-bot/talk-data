"""Freeze a saved public response fixture for --check-contract-only."""
...
class GoldenContractOkResponseTests(unittest.TestCase):
    def setUp(self):
        self.fixture_path = ROOT / "fixtures" / "golden_contract_ok_response.json"
