...
def verify_replay(address: dict[str, Any], evidence: list[dict[str, Any]], record: dict[str, Any]) -> dict[str, Any]:
    ...
    outcome = resolution_gate.resolve(address, evidence, record["evaluated_at"])
